...
<div class="container">
    ...
    <div class="form-group text-center">
        {!! Form::label('What is the the image for the boat?') !!}
    ...
    <div class="form-group text-center">
        <button class="btn btn-primary" onClick="addBoat()">Update Details</button>
...
function addBoat() {
    boatRef = new Firebase('https://hopwaveb.firebaseio.com/'+$('#boat_name_en').val());
    enRef = new Firebase('https://hopwaveb.firebaseio.com/'+$('#boat_name_en').val()+'/en');
    grRef = new Firebase('https://hopwaveb.firebaseio.com/'+$('#boat_name_en').val()+'/gr');
